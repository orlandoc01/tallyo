...
-- Used by GraphQL mutation addUser (admin.graphql) via the admin service to create and invite a new user (invitation reuses the email magic-link flow).
-- name: InsertUser :one
